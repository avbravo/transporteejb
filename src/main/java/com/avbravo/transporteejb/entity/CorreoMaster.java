...
public class CorreoMaster {
    ...
    public CorreoMaster(String email, String password, String mail_smtp_host, String mail_smtp_auth, String mail_smtp_port, String mail_smtp_starttls_enable) {
        this.email = email;
